...
export const phoneBlacklistModel = new Elysia({ name: "phoneBlacklistModel" }).model({
  "phoneBlacklist.create.body": createBodySchema,
  "phoneBlacklist.list.query": listQuerySchema,
  "phoneBlacklist.id.params": idParamSchema,
});
